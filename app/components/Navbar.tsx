...
export default function Component() {
  ...
  const isDarkText = (isHomePage && !isScrolled && !isMobileMenuOpen) ? false : true;
  const textColor = isDarkText ? "text-black" : "text-white";
  const bgColor = (isScrolled || isMobileMenuOpen) ? "bg-white shadow-md" : "bg-transparent";
  
  const isRTL = language === "ar";

  const navItems = [
    { href: "/", label: content[language as keyof typeof content].home },
    { href: "/services", label: content[language as keyof typeof content].services },
    { href: "#contact", label: content[language as keyof typeof content].contact },
